...
namespace ChessLibrary.MoveGeneration
{
    public class MoveGenerator : IMoveGenerator
    {
        ...
        {
            ValidPawnMoves(ref moves, b, color, enPassantFile, includeQuietMoves, false);
            ValidKnightMoves(ref moves, b, color, includeQuietMoves, false);
            ValidRookMoves(ref moves, b, color, includeQuietMoves, false);
            ValidBishopMoves(ref moves, b, color, includeQuietMoves, false);
            ValidQueenMoves(ref moves, b, color, includeQuietMoves, false);
        ...
        private static void ValidPawnMoves(
            ref MoveListContainer container,
            FullBitBoard b,
            Colors color,
            Files? enPassantFile,
        ...
        {
            MagicSlidingImplementation.ValidBishopMoves(ref moves, b, color, includeQuietMoves, (b, m, c) => includeSelfChecks ? false : ResultsInOwnCheck(b, m, c));
        }
        ...
        {
            MagicSlidingImplementation.ValidRookMoves(ref moves, b, color, includeQuietMoves, (b, m, c) => includeSelfChecks ? false : ResultsInOwnCheck(b, m, c));
        }
        ...
        {
            MagicSlidingImplementation.ValidQueenMoves(ref moves, b, color, includeQuietMoves, (b, m, c) => includeSelfChecks ? false : ResultsInOwnCheck(b, m, c));
        }
