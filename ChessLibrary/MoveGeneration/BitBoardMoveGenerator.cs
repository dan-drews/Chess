...
namespace ChessLibrary.MoveGeneration
{
    public class BitBoardMoveGenerator : IMoveGenerator
    {
        ...
        public Move[]? GetAllLegalMoves(IBoard b, SquareState squareState, Files? enPassantFile, bool blackCanLongCastle, bool blackCanShortCastle, bool whiteCanLongCastle, bool whiteCanShortCastle, bool ignoreCheck = false, bool includeQuietMoves = true)
        {
