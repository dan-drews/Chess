...
{
    public struct NewMove : ICloneable
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return SameMove((NewMove)obj, this);
        }
        ...
        public static bool SameMove(NewMove a, NewMove b)
        {
