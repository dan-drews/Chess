...
namespace ChessLibrary
{
    public static class MoveOrdering
    {
        ...
        public static IEnumerable<Move> OrderMoves(
            this IEnumerable<Move> moves,
            Engine engine,
            Move? previousBest
        )
        {
            return moves
                ...
                .ThenByDescending(x =>
                {
                    ...
                    {
                        score +=
                            CAPTURED_PIECE_MULTIPLIER
                            * (
                                x.CapturedPiece == null
                                    ? 0
                                    : engine.Scorer.GetPieceValue(x.CapturedPiece.Value)
                            );
